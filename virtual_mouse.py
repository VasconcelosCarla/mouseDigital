...
def countFingers(image, hand_landmarks, handNo=0):
	...
	if hand_landmarks:
		...
		print("Tamanho da Tela do Computador: ", screen_width, screen_height, "Tamanho da Janela", width, height)
		print("Posição do Mouse", mouse.position, "Posição central das Pontas: ", center_x, center_y)
